...
namespace SmartAutoTrader.API.Controllers
{
    ...
    public class ChatController : ControllerBase
    {
        ...
        public class RecommendationParametersDto
        {
            ...
            public List<string> PreferredVehicleTypes { get; set; } = new List<string>();
            public List<string> PreferredFuelTypes { get; set; } = new List<string>();
            public List<string> DesiredFeatures { get; set; } = new List<string>();
        }
        ...
        public async Task<IActionResult> SendMessage([FromBody] ChatMessageDto message)
        {
            try
            {
                ...
                var responseDto = new ChatResponseDto
                {
                    ...
                    Parameters = response.UpdatedParameters != null ? new RecommendationParametersDto
                    {
        ...
        [HttpGet("history")]
        public async Task<IActionResult> GetChatHistory([FromQuery] int limit = 10, [FromQuery] string conversationId = null)
        {
            try
            {
                // Get the user ID from the claims

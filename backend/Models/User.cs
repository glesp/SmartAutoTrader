...
namespace SmartAutoTrader.API.Models
{
    ...
    public class UserPreference
    {
        ...
        [Required] public string PreferenceType { get; set; } = null!; // e.g., "PriceRange", "VehicleType", "FuelType"

        [Required] public string Value { get; set; } = null!; // Store as JSON if needed for complex values

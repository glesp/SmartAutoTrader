/* <copyright file="CreateVehicleDTO.cs" company="PlaceholderCompany">
 * Copyright (c) PlaceholderCompany. All rights reserved.
 * </copyright>
 *
<summary>
This file defines the CreateVehicleDto class, which serves as a Data Transfer Object (DTO) for creating new vehicle records in the Smart Auto Trader application.
</summary>
<remarks>
The CreateVehicleDto class is used to encapsulate data required for creating a new vehicle record. It includes validation attributes to ensure that the provided data meets the application's requirements, such as valid ranges for year, price, mileage, and engine size. This DTO is typically used in API requests to add new vehicles to the system.
</remarks>
<dependencies>
...
namespace SmartAutoTrader.API.DTOs
{
    ...
    /// <summary>
    /// Represents a Data Transfer Object (DTO) for creating new vehicle records.
    /// </summary>
    /// <remarks>
    /// This class is used to encapsulate the data required for creating a new vehicle record, including validation rules for each property. It is designed for use in API requests.
    /// </remarks>
    public class CreateVehicleDto
    {
        ...
        /// <summary>
        /// Gets or sets the mileage of the vehicle, if applicable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the vehicle type (e.g., Sedan, SUV).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the engine size of the vehicle, if applicable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the country of origin for the vehicle, if applicable.
        /// </summary>

namespace SmartAutoTrader.API.DTOs
{
    ...
    public class UpdateVehicleDto
    {
        ...
        public string FuelType { get; set; } = string.Empty; // Will be parsed to enum in controller

        [Required(ErrorMessage = "Transmission type is required.")]
        public string Transmission { get; set; } = string.Empty; // Will be parsed to enum in controller

        [Required(ErrorMessage = "Vehicle type is required.")]
        public string VehicleType { get; set; } = string.Empty; // Will be parsed to enum in controller
        ...
        // Assumes VehicleFeatureDto is defined in its own file or accessible here
